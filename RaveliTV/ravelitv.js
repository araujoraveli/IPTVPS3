...
service.create(plugin.title, plugin.id + ':start', 'RaveliTV', true, logo);
...
new page.Route(plugin.id + ':start', function(page) {
  ...
  if (service.selectRegion == "Off") {page.metadata.icon = logo; setPageHeader(page, "RaveliTV")};
  if (service.selectRegion == "Brazil") {page.metadata.icon = 'https://naurok-test2.nyc3.digitaloceanspaces.com/uploads/test/2225640/1287696/204682_1644400839.png'; setPageHeader(page, "RaveliTV | BR")};
  ...
  if (service.updatechannel == "Stable") {
    page.options.createAction('update', "Check for Updates", function() 
    {
      ...
      page.redirect('https://github.com/dajesusmodz/araujoraveli/releases/latest/download/vuepro_stable.zip');
    });
  }
  ...
  if (service.updatechannel == "Pre-Release") {
    ...
    {
      popup.notify("Updating, please wait...", 7);
      page.redirect('https://raw.githubusercontent.com/araujoraveli/master/vuepro_unstable.zip');
    });
  }
  ...
  if (service.selectRegion == "Off") {
    page.appendItem('', 'separator', {title: 'Navigate to "Movian > Settings > RaveliTV > Channel Region:" to watch Free Channels.'});
  }
  ...
  if (service.selectRegion == "Brazil") {
    page.appendItem('', 'separator', {title: ''});
    page.appendItem('', 'separator', {title: '  Canais da Pluto TV:                                                                                                                                                                                                                                                               '});
    page.appendItem('', 'separator', {title: ''});
  ...
  // FreeTV
    ...
    if (service.selectRegion == "Brazil") {
    page.appendItem('', 'separator', {title: ''});
    page.appendItem('', 'separator', {title: '  Canais abertos e pagos:                                                                                                                                                                                                                                                                                 '});
    page.appendItem('', 'separator', {title: ''});
    page.appendItem('https://cdn-3.nxplay.com.br/SBT_HD_SIMBA_NEW/index.m3u8', 'playable', { title: 'SBT', icon: 'https://raw.githubusercontent.com/skyrisk/brazucaplay/master/logos/sbt.png', }); // 10/05/24
    page.appendItem('https://cdn-3.nxplay.com.br/RECORD_HD_TK/index.m3u8', 'playable', { title: 'Record', icon: 'https://www.sky.com.br/documents/1407842/29152427/99x38_LOGO_SKY_RECORDTV.png', }); // 10/05/24
    page.appendItem('https://cdn-3.nxplay.com.br/REDETV_NEW/index.m3u8', 'playable', { title: 'Rede TV', icon: 'https://upload.wikimedia.org/wikipedia/pt/8/89/Logotipo_da_RedeTV%21.png', }); // 10/05/24
    page.appendItem('https://cdn-3.nxplay.com.br/ANIMAL_PLANET_NX/index.m3u8', 'playable', { title: 'Animal Planet', icon: 'https://github.com/skyrisk/brazucaplay/blob/master/logos/animal_planet.png?raw=true', }); // 10/05/24
    page.appendItem('m3uGroup:https%3A%2F%2Fraw.githubusercontent.com/araujoraveli/List.m3u-for-PS3/main/lista.m3u:Brazil', 'directory', { title: 'Show All...', icon: 'https://i.postimg.cc/cJLV4kMN/seemore.png', }); // 10/05/24
  }
  ...
  page.appendItem('', 'separator', {title: ''});
  page.appendItem('', 'separator', {title: '  RaveliTV Version:  3.2 (Release)                                                                                                                                                                                                                                                          '});
  page.appendItem('', 'separator', {title: ''});
